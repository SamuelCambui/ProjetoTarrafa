...
} from '/ppg/js/modules/ppg/fetchers.js';
...
export function ShowChartInModal(idChart){
	...
	switch(idChartModal){
		...
		case 'chartqualisdiscenteproductionsmodal':
			fetch_qualis_discente_ppg(idChartModal);
			break;
		...
		case 'chartindprodextsupsproductionsmodal':
			fetch_indprods_extsups_ppg(idChartModal);
			break;
...
export function InsertChartAgain(){
	...
	switch(idChart){
		...
		case 'chartqualisdiscenteproductions':
			fetch_qualis_discente_ppg(idChart);
			break;
		
		case 'chartindprodextsupsproductions':
			fetch_indprods_extsups_ppg(idChart);
			break;
