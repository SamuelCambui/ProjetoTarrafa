  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>  G/F, onde G = quantidade de produtos e F = corpo discente + egressos 5 anos 
        Índice de produtos com autoria discente. Todos os produtos menos apresentação de trabalhos </CardDescription>
      </CardHeader>
      <CardContent>
        <DualAxes {...config} /> 
      </CardContent>
