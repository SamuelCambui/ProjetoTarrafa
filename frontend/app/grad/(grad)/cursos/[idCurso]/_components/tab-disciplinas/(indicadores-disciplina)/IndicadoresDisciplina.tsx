...
import { useIndicadoresDisciplina } from "@/service/grad/indicadores/queries";
...
import { BoxplotProvaFinal } from "./BoxplotProvaFinal";
...
import { GraficoQuantidadeProvaFinal } from "./GraficoQuantidadeProvaFinal";
...
export const IndicadoresDisciplina = ({
  ...
  // Controla o componente do combobox
    ...
    <div className="space-y-2">
      ...
      {fetchedDiscipline && (
        <>
          ...
          />
          <div className="grid grid-cols-2 gap-2">
            <GraficoQuantidadeProvaFinal
              data={data?.graficoProvaFinal}
              isLoading={isLoading}
            />
            <BoxplotProvaFinal
              data={data?.boxplotProvaFinalDisciplina}
              isLoading={isLoading}
            />
          </div>
        </>
