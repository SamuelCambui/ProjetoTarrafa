...
def tarefa_retorna_indori(id: str, anoi: int, anof: int, nota: str):
	try:
		...
		data_avg = crud.queries_ppg.retorna_indori_medio(id, anoi, anof)
...
def tarefa_retorna_inddistori(id: str, anoi: int, anof: int, nota: str):
	try:
		...
		data_avg = crud.queries_ppg.retorna_inddistori_medio(id, anoi, anof)
...
def tarefa_retorna_indaut(id: str, anoi: int, anof: int, nota: str):
	try:
		...
		data_avg = crud.queries_ppg.retorna_indaut_medio(id, anoi, anof)
...
def tarefa_retorna_inddis(id: str, anoi: int, anof: int, nota: str):
	try:
		...
		data_avg = crud.queries_ppg.retorna_inddis_medio(id, anoi, anof)
...
def tarefa_retorna_partdis(id: str, anoi: int, anof: int, nota: str):
	try:
		...
		data_avg = crud.queries_ppg.retorna_partdis_medio(id, anoi, anof)
...
def tarefa_retorna_indcoautoria(id: str, anoi: int, anof: int, nota: str):
	try:
		...
		data_avg = crud.queries_ppg.retorna_indcoautoria_medio(id, anoi, anof)
