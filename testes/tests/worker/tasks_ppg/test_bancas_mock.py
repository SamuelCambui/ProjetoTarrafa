...
@pytest.fixture
def mock_crud():
    with patch("backend.worker.tasks_ppg.crud.queries_ppg") as mock:
        yield mock
...
def test_tarefa_retorna_dados_de_tccs_por_linhas_pesquisa_com_erro(params_tasks, mock_crud):
    from backend.worker.tasks_ppg.task_bancas import tarefa_retorna_dados_de_tccs_por_linhas_de_pesquisa
    # Configura o mock para lançar uma exceção
    mock_crud.retorna_dados_de_tccs_por_linhas_de_pesquisa.side_effect = Exception("Erro simulado")
